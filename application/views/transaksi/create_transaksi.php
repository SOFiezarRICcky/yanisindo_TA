<div class="container">
    <div class="row">
        <div class="col">
            ...
            <form method="POST" action="<?= base_url(); ?>admin/insert_transaksi_header" id="form_transaksi">
                <div class="form-group row">
                    <label for="" class="control-label col-sm-2">No Faktur</label>
                    <div class="col-md-3">
                        <input type="text" name="no_faktur" class="form-control" id="no_faktur" value="NF-<?php echo sprintf("%03s", $no_faktur_baru) ?>" readonly>
                        <input type="hidden" name="no_faktur_header" class="form-control" id="no_faktur_header" value="NF-<?php echo sprintf("%03s", $no_faktur_baru) ?>">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input list="data_customer" class="form-control" type="text" name="kode_customer" id="kode_customer" placeholder="Kode / Nama" onchange="return autofill_cus(); ">
                    </div>
                    <label for="" class="control-label col-sm">Nama Customer</label>
                    <div class="col-md-3">
                        <input type="text" name="nama_customer" class="form-control" id="nama_customer" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input type="text" id="pajak" name="pajak" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-2">
