<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <form action="<?= base_url("admin/create_obat"); ?>" method="post">
                <div class="row mb-3">
                    <label for="kode_obat" class="col-sm-2 col-form-label">Kode Obat</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kode_obat" name="kode_obat" value="KB-<?php echo sprintf("%03s", $kode_obat) ?>" readonly>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_obat" name="nama_obat" autofocus value="<?= set_value("nama_obat"); ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="expired_obat" name="expired_obat">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="isi_per_q" name="isi_per_q" value="<?= set_value("isi_per_q"); ?>">
                        <?= form_error("isi_per_q", "<small class='text-danger pl-3'>", "</small>"); ?>
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="harga_ppn" name="harga_ppn" readonly value="<?= set_value("harga_ppn"); ?>">
                    </div>
                </div>
                <!-- <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <label for="harga_total" class="col-sm-2 col-form-label">Harga PPN</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="harga_total" name="harga_total" readonly value="<?= set_value("harga_total"); ?>">
                    </div>
                </div>
